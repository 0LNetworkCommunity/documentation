...
## Description
The Libra wallet tool provides essential functionalities for managing digital wallets within the OpenLibra ecosystem. It is designed to handle digital currencies and assets through secure key management, account maintenance, and transaction processes.
...
The wallet CLI tool offers a user-friendly command-line interface for interacting with the OpenLibra. Key functionalities include:
