...
#### Overview
To participate in the bidding process for the next epoch, validators must maintain compliance. Non-compliant validators at the time of an epoch change will be [jailed](../tools/txs/validator.md#manage-jail-operations) and must be un-jailed by one of the active validators to re-enter the process.
